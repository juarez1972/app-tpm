...
#
# Faz, de ponta a ponta, o provisionamento de um dispositivo para o fluxo MQTT:
#   1. Verifica o TPM.
...
#      para que o server_mqtt.py valide o TOTP do dispositivo.
#
...
info "Próximo passo: suba o cliente MQTT (o segredo será recuperado do TPM):"
echo "  DEVICE_ID=${DEVICE_ID} python3 client_mqtt.py"
exit 0
